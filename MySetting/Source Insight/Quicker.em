...
macro FuncHeadCommentCN(hbuf, ln, szFunc, szMyName,newFunc)
{
    ...
    InsBufLine(hbuf, ln+3, "** ·µ »Ø Öµ  : @szRet@")
    //InsBufLine(hbuf, ln+5, " µ÷ÓÃº¯Êý  : ")
    //InsBufLine(hbuf, ln+6, " ±»µ÷º¯Êý  : ")
    //InsbufLIne(hbuf, ln+7, " ");
    //InsBufLine(hbuf, ln+4, " ÐÞ¸ÄÀúÊ·      :")
    InsBufLine(hbuf, ln+4, "       ")
    SysTime = GetSysTime(1);
    szTime = SysTime.Date

    InsBufLine(hbuf, ln+5, "** ÈÕ    ÆÚ  : @szTime@")
    ...
    {
       InsBufLine(hbuf, ln+6, "** ×÷    Õß  : #")
    }
    //InsBufLine(hbuf, ln+7, " ÐÞ¸ÄÄÚÈÝ  : ÐÂÉú³Éº¯Êý")    
